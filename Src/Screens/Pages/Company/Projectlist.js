...
// Imports: Redux Actionsimport {login} from '../../../../redux/actions/authActions';
import {
  increaseCounter,
  decreaseCounter,
...
class ProjectList extends React.Component {
    ...
    _getProject = async () => {
        try{
          ...
          const auth = await Axios.get('http://54.161.87.89:7000/myhire/readproject')
    ...
    _changeDone = async(id, done) =>{
      try{
        ...
        Axios.defaults.headers.common['Authorization'] = this.props.token;
        const auth = await Axios.put('http://54.161.87.89:7000/myhire/doneproject',
          {
            id,
            done
          }
